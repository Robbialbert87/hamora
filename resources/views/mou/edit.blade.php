...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <div class="mb-3">
                    <h4 class="card-title mb-0">Form Edit MOU</h4>
                    <p class="text-muted mb-0">Ubah data MOU / perjanjian kerja sama</p>
                </div>

                <form action="{{ route('mou.update', $mou->id) }}" method="POST" enctype="multipart/form-data" novalidate>
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="pihak"
                                    ...
                                    value="{{ old('pihak', $mou->pihak) }}" required>
                                @error('pihak')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="judul"
                                    ...
                                    value="{{ old('judul', $mou->judul) }}" required>
                                @error('judul')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="bidang_id" class="form-select @error('bidang_id') is-invalid @enderror">
                                    ...
                                    @foreach ($bidang as $b)
                                        <option value="{{ $b->id }}" {{ old('bidang_id', $mou->bidang_id) == $b->id ? 'selected' : '' }}>{{ $b->nama }}</option>
                                    @endforeach
                                </select>
                                @error('bidang_id')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="kategori_id" class="form-select @error('kategori_id') is-invalid @enderror">
                                    ...
                                    @foreach ($kategori as $k)
                                        <option value="{{ $k->id }}" {{ old('kategori_id', $mou->kategori_id) == $k->id ? 'selected' : '' }}>{{ $k->nama }}</option>
                                    @endforeach
                                </select>
                                @error('kategori_id')
                                    <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="nomor"
                                    ...
                                    value="{{ old('nomor', $mou->nomor) }}" required>
                                @error('nomor')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="mulai_perjanjian" id="mulai_perjanjian"
                                    ...
                                    value="{{ old('mulai_perjanjian', $mou->mulai_perjanjian?->format('Y-m-d')) }}" required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="masa_berlaku" id="masa_berlaku"
                                    ...
                                    <option value="30" {{ old('masa_berlaku', $mou->masa_berlaku) == 30 ? 'selected' : '' }}>1 Bulan</option>
                                    <option value="90" {{ old('masa_berlaku', $mou->masa_berlaku) == 90 ? 'selected' : '' }}>3 Bulan</option>
                                    <option value="180" {{ old('masa_berlaku', $mou->masa_berlaku) == 180 ? 'selected' : '' }}>6 Bulan</option>
                                    <option value="365" {{ old('masa_berlaku', $mou->masa_berlaku) == 365 ? 'selected' : '' }}>1 Tahun</option>
                                    <option value="730" {{ old('masa_berlaku', $mou->masa_berlaku) == 730 ? 'selected' : '' }}>2 Tahun</option>
                                    <option value="1095" {{ old('masa_berlaku', $mou->masa_berlaku) == 1095 ? 'selected' : '' }}>3 Tahun</option>
                                    <option value="1460" {{ old('masa_berlaku', $mou->masa_berlaku) == 1460 ? 'selected' : '' }}>4 Tahun</option>
                                    <option value="1825" {{ old('masa_berlaku', $mou->masa_berlaku) == 1825 ? 'selected' : '' }}>5 Tahun</option>
                                    <option value="2190" {{ old('masa_berlaku', $mou->masa_berlaku) == 2190 ? 'selected' : '' }}>6 Tahun</option>
                                    <option value="2555" {{ old('masa_berlaku', $mou->masa_berlaku) == 2555 ? 'selected' : '' }}>7 Tahun</option>
                                    <option value="2920" {{ old('masa_berlaku', $mou->masa_berlaku) == 2920 ? 'selected' : '' }}>8 Tahun</option>
                                    <option value="3285" {{ old('masa_berlaku', $mou->masa_berlaku) == 3285 ? 'selected' : '' }}>9 Tahun</option>
                                    <option value="3650" {{ old('masa_berlaku', $mou->masa_berlaku) == 3650 ? 'selected' : '' }}>10 Tahun</option>
                                </select>
                                @error('masa_berlaku')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="date" name="akhir_perjanjian" id="akhir_perjanjian"
                                    ...
                                    value="{{ old('akhir_perjanjian', $mou->akhir_perjanjian?->format('Y-m-d')) }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="status"
                                    ...
                                    <option value="aktif" {{ old('status', $mou->status) == 'aktif' ? 'selected' : '' }}>Aktif</option>
                                    <option value="kadaluarsa" {{ old('status', $mou->status) == 'kadaluarsa' ? 'selected' : '' }}>Kadaluarsa</option>
                                    <option value="dicabut" {{ old('status', $mou->status) == 'dicabut' ? 'selected' : '' }}>Dicabut</option>
                                </select>
                                @error('status')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                @error('file_pdf')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <div class="text-muted mt-1" style="font-size: 12px;">Format: PDF, Maks: 20MB. Biarkan kosong jika tidak ingin mengubah file.</div>
                            </div>
                        </div>
                    </div>
