...
@section('page-title', 'Upload MOU (Kerja Sama)')
    ...
    <section class="content-grid" style="grid-template-columns: 1fr;">
        <div class="glass-card" style="grid-column: span 1;">
            <div class="card-header">
                <div>
                    <h2 class="card-title">Form Upload MOU (Kerja Sama)</h2>
                    <p class="card-subtitle">Lengkapi form di bawah untuk upload dokumen MOU dengan masa berlaku</p>
                </div>
            </div>
