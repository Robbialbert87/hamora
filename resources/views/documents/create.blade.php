                        ...
                        <div id="collapseBaru" class="accordion-collapse collapse" data-bs-parent="#uploadAccordion">
                            <div class="accordion-body">
                                <div class="row g-4">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label">Nomor Dokumen <span
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label class="form-label">Tanggal Terbit <span
                                                    class="text-danger">*</span></label>
                                ...
                                <div class="mt-4 d-flex gap-3">
                                    <button type="submit" class="btn-emerald"><i class="fas fa-save"></i> Simpan Dokumen
                                        Baru</button>
                                    <a href="{{ route('documents.index') }}" class="btn-outline-glass"><i
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseMOU" class="accordion-collapse collapse" data-bs-parent="#uploadAccordion">
                            <div class="accordion-body">
                                ...
                                <div class="mt-4 d-flex gap-3">
                                    <button type="submit" class="btn-emerald"><i class="fas fa-save"></i> Simpan
                                        MOU</button>
                                    <a href="{{ route('documents.index') }}" class="btn-outline-glass"><i
                                            class="fas fa-arrow-left"></i> Kembali</a>
                                </div>
                            ...
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                <div class="d-flex align-items-center gap-3 w-100">
                                    ...
                                    <div>
                                        ...
                                        <small class="text-muted">Update dokumen yang sudah tidak berlaku atau
                                            dicabut</small>
                                    </div>
                                </div>
                            </button>
                        ...
                        <div id="collapseUpdate" class="accordion-collapse collapse" data-bs-parent="#uploadAccordion">
                            <div class="accordion-body">
                                <div class="row g-4">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label class="form-label">Cari Dokumen yang akan di Update <span
                                                    class="text-danger">*</span></label>
                                            <div class="row g-2 mb-3">
                                                ...
                                                <div class="col-md-4 d-flex align-items-end gap-2">
                                                    <button type="button" class="btn-emerald btn-sm flex-fill"
                                                        onclick="filterDocuments()"><i class="fas fa-search"></i>
                                                        Cari</button>
                                            ...
                                            <div id="documentList"
                                                ...
                                                <div id="filterEmpty" class="px-3 py-3 text-muted text-center"
                                                    style="font-size: 14px; display: none;">Tidak ada dokumen yang cocok
                                                    dengan pencarian.</div>
                                                ...
                                                @empty
                                                    <div class="px-3 py-3 text-muted text-center"
                                                        style="font-size: 14px;">Tidak ada dokumen yang tersedia untuk
                                                        diupdate.</div>
                                                @endforelse
                                            </div>
                                            <div id="selectedDoc" class="mt-2" style="display: none;">
                                                <div class="d-flex align-items-center gap-2 px-3 py-2 rounded-3"
                                                    ...
                                                    <span id="selectedDocText" class="text-success fw-medium"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nama_dokumen"
                                                class="form-control @error('nama_dokumen') is-invalid @enderror"
                                                value="{{ old('nama_dokumen') }}" required
                                                placeholder="Nama update dokumen">
                                            @error('nama_dokumen')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
