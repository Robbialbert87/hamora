        ...
        <div class="page-title-box">
            <div class="float-end">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Diubah</li>
                </ol>
            </div>
            <h4 class="page-title">Update Dokumen - Diubah</h4>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <div class="mb-3">
                    <h4 class="card-title mb-0">Form Update Dokumen - Diubah</h4>
                    <p class="text-muted mb-0">Revisi dokumen dengan perubahan konten secara menyeluruh</p>
                </div>
