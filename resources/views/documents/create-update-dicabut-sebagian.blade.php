...
@section('title', 'Update Dokumen - Dicabut Sebagian - HAMORA')
@section('page-title', 'Update Dokumen - Dicabut Sebagian')
    ...
    <section class="content-grid" style="grid-template-columns: 1fr;">
        <div class="glass-card" style="grid-column: span 1;">
            <div class="card-header">
                <div>
                    <h2 class="card-title">Dicabut Sebagian</h2>
                    <p class="card-subtitle">Revisi parsial dimana poin tertentu dihapus dari dokumen</p>
                </div>
            ...
            <form action="{{ route('documents.store') }}" method="POST" enctype="multipart/form-data" id="formUpload" novalidate>
                @csrf
                <input type="hidden" name="jenis_upload" value="revisi">
                ...
                <div class="form-group mb-4">
                    <label class="form-label">Cari Dokumen yang akan direvisi parsial <span class="text-danger">*</span></label>
                    ...
                    <div id="documentList"
                        ...
                        @empty
                            <div class="px-3 py-3 text-muted text-center" style="font-size: 14px;">Tidak ada dokumen yang tersedia untuk direvisi.</div>
                        @endforelse
                    </div>
                ...
                {{-- Form Fields --}}
                <div id="sectionRevisi" class="form-section active">
                ...
                <div class="mt-4 d-flex gap-3">
                    <button type="submit" class="btn-emerald"><i class="fas fa-save"></i> Simpan Revisi Parsial</button>
